package Air_fla
{
    ...
    dynamic public class MainTimeline extends MovieClip
    {
        ...
        public function contentCompleteHandle(event:Event) : void
        {
			...
			{
				ExternalInterface.call("kv_story2_slider_show");
				ExternalInterface.call("kv_story2_slider_resetX");
			}
        ...
        public function selectedIndex(param1:Number) : void
        {
            ...
            if (this.data)
            {
                ...
                if (this.contentArr[value])
                {
                    this.content = this.contentArr[value];
                    this.addChild(this.contentArr[value]);
                }
                else
                {
                    var _loc_4:int = 0;
        ...
        function frame1()
        {
            //this.contentPath = "/consumerfiles/pageitems/locales/zh_CN/CONSUMER/categorypages/AirPurifier_OneChina_2011/assets/flash/";
            this.contentPath = this.getPath();
            this.dataPath = this.contentPath + "data/content-2.xml";
            ...
            this.dateLoader.loadXml(this.dataPath + "");
            this.contentArr = [];
            this.currentIndex = -1;
			if ( ExternalInterface.available )
			{
