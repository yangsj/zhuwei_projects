...
//			if ( !_totalTime ) {
				var streamminute:Number = Math.floor(videoDuration / 60);
				var smin_str:String;
				if (streamminute>=10) {
				...
				var streamsecond:Number = Math.round(videoDuration % 60);
				var ssec_str:String;
				if (streamsecond>=10) {
...
//			}
		...
		public function onMetaData(infoObject:Object):void {
			...
			trace( infoObject.width );				
			trace ( infoObject.height);
			/*var key:String;
