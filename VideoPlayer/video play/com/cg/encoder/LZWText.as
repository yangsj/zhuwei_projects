...
package com.cg.encoder
{
	public class LZWText {
		...
		public static function compress(str:String):String {
			...
			trace("<<<<<<<<<<<<<<text LZW compress, source length= "+str.length+", comress length= "+res.length +", compress rate="+res.length/str.length+"  >>>>>>>>>>")
			return res;
		}
